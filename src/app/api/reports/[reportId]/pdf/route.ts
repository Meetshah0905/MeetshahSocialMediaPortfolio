...
export async function GET(
  ...
  } else if (isChannelSlug(reportId.split("-").slice(0, 2).join("-"))) {
  ...
  if (!report || report.status !== "published" || !report.pdfUrl) {
  ...
  // Local dev: the PDF lives under public/uploads/<storageKey>.
